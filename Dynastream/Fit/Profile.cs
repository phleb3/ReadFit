...
namespace Dynastream.Fit
{
   ...
   public static class Profile
   {
      ...
      {                                                             
         ...
         fieldIndex++;
         monitoringMesg.SetField(new Field("Cycles", 3, 134, 1f, 0f, "cycles"));
         fieldIndex++;
         ...
         fieldIndex++;
         monitoringMesg.SetField(new Field("CompressedDistance", 8, 132, 1f, 0f, ""));                   
         monitoringMesg.fields[fieldIndex].components.Add(new FieldComponent(2, true, 16, 100f, 0f)); // distance
         fieldIndex++;
         monitoringMesg.SetField(new Field("CompressedCycles", 9, 132, 1f, 0f, ""));                   
         monitoringMesg.fields[fieldIndex].components.Add(new FieldComponent(3, true, 16, 1f, 0f)); // cycles
         fieldIndex++;
         monitoringMesg.SetField(new Field("CompressedActiveTime", 10, 132, 1f, 0f, ""));                   
         monitoringMesg.fields[fieldIndex].components.Add(new FieldComponent(4, true, 16, 1f, 0f)); // active_time
         fieldIndex++;
